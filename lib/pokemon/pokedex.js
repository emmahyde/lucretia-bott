...
const pokedex = async (msg, args) => {
  ...
  try {
    ...
    if (res.status>200) {
      return msg.channel.createMessage({content: `We have no records for a Pokémon called "**${pkmnName.toUpperCase()}**". Must be new, call the professor!`,  embed: { image: { url: fallbackimg}} })
    }
    ...
    return msg.channel.createMessage({ content: 'Unexpected PokéDex malfunction. Hopefully you got Apple Care on that.', embed: {image: {url: 'https://static2.cbrimages.com/wordpress/wp-content/uploads/2019/10/Brock.jpg'}} })
  }
}
